...
class Page_4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_page_4, container, false)
        view.page_4_recyclerview_id.layoutManager = GridLayoutManager(context, 1)
        list = ArrayList()
        list.add(
        ...
        val adapters = Page_4_RecyclerView(list)
        view.page_4_recyclerview_id.adapter = adapters
        return view
    }
