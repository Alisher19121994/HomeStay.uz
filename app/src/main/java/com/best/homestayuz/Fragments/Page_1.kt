...
import com.best.homestayuz.Fragment_Adapter_RecyclerView.Page_1_RecyclerView
import com.best.homestayuz.R
import kotlinx.android.synthetic.main.fragment_page_1.view.*
...
class Page_1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_page_1, container, false)
        view.page_1_recyclerview_id.layoutManager = GridLayoutManager(context, 1)
        list = ArrayList()
        list.add(
        ...
        val adapters = Page_1_RecyclerView(list)
        view.page_1_recyclerview_id.adapter = adapters
        return view
    }
