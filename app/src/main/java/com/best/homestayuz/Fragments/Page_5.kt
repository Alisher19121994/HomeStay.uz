...
import com.best.homestayuz.Fragment_Adapter_RecyclerView.Page_4_RecyclerView
import com.best.homestayuz.Fragment_Adapter_RecyclerView.Page_5_RecyclerView
import com.best.homestayuz.R
import kotlinx.android.synthetic.main.fragment_page_4.view.*
import kotlinx.android.synthetic.main.fragment_page_5.view.*

class Page_5 : Fragment() {
    lateinit var list: ArrayList<String>
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view: View = inflater.inflate(R.layout.fragment_page_5, container, false)
        view.page_5_recyclerview_id.layoutManager = GridLayoutManager(context, 1)
        list = ArrayList()
        list.add(
        ...
        val adapters = Page_5_RecyclerView(list)
        view.page_5_recyclerview_id.adapter = adapters
        return view
    }
