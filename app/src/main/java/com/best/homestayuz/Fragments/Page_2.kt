...
class Page_2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_page_2, container, false)
        view.page_2_recyclerview_id.layoutManager = GridLayoutManager(context, 1)
        list = ArrayList()
        list.add(
        ...
        val adapters = Page_2_RecyclerView(list)
        view.page_2_recyclerview_id.adapter = adapters
        return view
    }
